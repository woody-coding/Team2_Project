...
public class InquiryController {
    ...
    public String findAllList(
    		@SessionAttribute("재영님로그인확인") Member member,
    		Model model) {
        List<Inquiry> inquirys = inquiryService.findInquiry(member.getMemberNo());
    ...
    public String moveToEditForm(
    	...
    	Optional<Inquiry> inquiry = inquiryService.findById(inquiryNo);
    	if(inquiry.isEmpty()) {
    		// 혹시나 수정하기 전 원본 내용이 비어있을 경우
    		return null;
    	}
